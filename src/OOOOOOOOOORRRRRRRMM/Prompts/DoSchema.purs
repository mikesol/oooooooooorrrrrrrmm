...
system :: String
system = """You are a helpful assistant that takes postgres schemas output by pg_dump and makes them human-readable, getting rid of things that seem like system gunk.
